        ...
        <div className="relative w-full flex-grow min-h-[55vh] bg-spacePanel/80 border-4 border-black rounded-3xl shadow-comicLg backdrop-blur-md overflow-hidden">
          ...
          <div className="absolute top-[10%] right-[10%] md:top-[15%] md:right-[20%] transform transition-transform hover:scale-105 z-10">
            <button 
              ...
              onTouchStart={() => handleObjectClick("CLUE 4: The cameras show someone walking towards the Medical bay.")}
          ...
          <div className="absolute top-[45%] left-[5%] md:top-[40%] md:left-[15%] transform transition-transform hover:scale-105 z-10">
            <button 
              ...
              onTouchStart={() => handleObjectClick("CLUE 5: The ship is off course by 45 degrees.")}
              className="group flex flex-col items-center focus:outline-none"
            >
              ...
              <span className="font-black text-[10px] sm:text-xs md:text-sm uppercase text-white mt-2 bg-black px-2 py-1 border-2 border-crewCyan rounded shadow-comic text-crewCyan">
                Navigation
              </span>
            </button>
          </div>
          ...
          <div className="absolute bottom-[10%] right-[20%] md:bottom-[15%] md:right-[30%] transform transition-transform hover:scale-105 z-10">
            <button 
              ...
              onTouchStart={() => handleObjectClick("CLUE 6: A garbled transmission repeats the word 'Oxygen'.")}
              className="group flex flex-col items-center focus:outline-none"
            >
